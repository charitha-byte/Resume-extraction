...
def data_display(textinput):
    ...
    with open(
            f"C:/Users/Charitha G/Downloads/Resume-Parsing-using-NLP-main/Resume-Parsing-using-NLP-main/output/{re.sub('[^A-Za-z]', '', out_data['Name'])}_{skill_set.split('/')[-1].replace('.csv','')}_result.json",
            "w") as outfile:
